...
export default function Footer() {
  return (
    <footer className="bg-gradient-gray-light pt-8 md:pt-12 pb-4 md:pb-6 border-t border-gray-200">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center text-xs text-gray-500 mt-6 md:mt-8">
          <p className="mb-2 font-semibold text-gray-700 text-xs md:text-sm">
          ...
          <p className="mb-4 md:mb-6 max-w-4xl mx-auto leading-relaxed text-gray-600 text-xs md:text-sm px-4">
